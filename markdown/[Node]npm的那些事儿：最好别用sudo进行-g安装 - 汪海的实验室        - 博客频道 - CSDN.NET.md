...
](/pleasecallmewhy/article/details/35987757)

分类： [ Node.js ](/wxg694175346/article/category/2036855) 2014-06-30 11:23
545人阅读  评论  (0)  [ 收藏 ](javascript:void\(0\);) 举报

今天看到how to node 上的一篇文章： [ http://howtonode.org/introduction-to-npm
](http://howtonode.org/introduction-to-npm) ，其中关于sudo的一段深有体会，分享给大家。
...
这样就再也不需要sudo命令了。
  ...
  * 上一篇  [ [C++]C++11 语法记录: Lambda简单入门 ](/pleasecallmewhy/article/details/34941721)
  * 下一篇  [ [Cocos2d-x]在Cocos2d-x 3.x版本中如何通过WebSocket连接服务器进行数据传输 ](/pleasecallmewhy/article/details/36686787)

主题推荐

     [ 管理 ](http://www.csdn.net/tag/管理) [ 脚本 ](http://www.csdn.net/tag/脚本) [ 安全 ](http://www.csdn.net/tag/安全) [ pre ](http://www.csdn.net/tag/pre) [ class ](http://www.csdn.net/tag/class)
