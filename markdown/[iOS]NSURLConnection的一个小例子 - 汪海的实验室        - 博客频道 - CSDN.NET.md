...
分类： [ iOS ](/wxg694175346/article/category/1512775) 2015-01-29 10:22  287人阅读
...
也可以直接用Block发个异步请求：
  ...
  * 上一篇  [ [iOS]在iOS8创建一个交互性强的本地通知 ](/pleasecallmewhy/article/details/42913175)
  * 下一篇  [ [iOS]UITextView在输入内容时光标不在最下方的解决方案 ](/pleasecallmewhy/article/details/43503143)
...
主题推荐
     ...
     [ ios ](http://www.csdn.net/tag/ios) [ interface ](http://www.csdn.net/tag/interface) [ delegate ](http://www.csdn.net/tag/delegate) [ 异步 ](http://www.csdn.net/tag/异步) [ class ](http://www.csdn.net/tag/class)
