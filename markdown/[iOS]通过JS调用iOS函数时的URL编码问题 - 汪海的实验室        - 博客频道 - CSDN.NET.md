...
分类： [ iOS ](/wxg694175346/article/category/1512775) 2014-06-10 15:05  629人阅读
评论  (4)  [ 收藏 ](javascript:void\(0\);) 举报

在前面的文章： [ [iOS]在WebApp中如何使用JS调用iOS的函数
](http://blog.csdn.net/pleasecallmewhy/article/details/28403347)
中，提到了如何使用JS通过修改URL调用iOS的内部函数。
...
遇到这个问题主要是URL在转化中的编码问题，解决方案感谢这篇博文： [ iOS中的编码问题
](http://blog.csdn.net/flyter/article/details/7540918) 。
...
>> original: http://search.google.com?keywords=($# it's
{a*123})00!*'();:@&=+$,/?%#[]  
>> encoded:  http%3A%2F%2Fsearch.google.com%3Fkeywords%3D%28%24%23%20it%27s%20
%7Ba%2A123%7D%2900%21%2A%27%28%29%3B%3A%40%26%3D%2B%24%2C%2F%3F%25%23%5B%5D  
>> encoded2: http://search.google.com?keywords=($%23%20it's%20%7Ba*123%7D)00!*
'();:@&=+$,/?%25%23%5B%5D  
>> decoded:  http://search.google.com?keywords=($# it's
{a*123})00!*'();:@&=+$,/?%#[]  
...
如果服务器用的是GBK编码，只要把上面的UTF改成下面的encoding就可以了：
  ...
  * 上一篇  [ [API]使用Blueprint来高雅的编写接口文档 ](/pleasecallmewhy/article/details/29398559)
  * 下一篇  [ [Linux]在Mac下配置Linux服务器并安装Nginx+PHP ](/pleasecallmewhy/article/details/32104157)
...
主题推荐
     ...
     [ 编码 ](http://www.csdn.net/tag/编码) [ ios ](http://www.csdn.net/tag/ios) [ url ](http://www.csdn.net/tag/url) [ 解决方案 ](http://www.csdn.net/tag/解决方案) [ 服务器 ](http://www.csdn.net/tag/服务器)
