...
C++是個特別複雜的語言，其複雜性不僅體現在開發模式上，也體現在語法分析上。許多人都遇到過嵌套模板參數的歧義問題，如 `
vector<vector<int>> v ` ，在有些編譯器上會被解析爲 ` vector < vector < int >> v `
，但新的編譯器都已經解決了。而最讓人頭疼的歧義則是 [ Most vexing parse
...
####  語言
  ...
  * [ 原文 ](/blog/cpp-most-vexing-parse)
  * [ 正體中文 ](/zht/blog/cpp-most-vexing-parse)
  * [ 簡體中文 ](/zhs/blog/cpp-most-vexing-parse)
  * [ English ](/en/blog/cpp-most-vexing-parse)
