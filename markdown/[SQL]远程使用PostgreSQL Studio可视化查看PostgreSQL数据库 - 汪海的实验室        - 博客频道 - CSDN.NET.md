...
](/pleasecallmewhy/article/details/32313611)

分类： [ PostgreSQL ](/wxg694175346/article/category/2343533) 2014-06-19 10:16
863人阅读  评论  (0)  [ 收藏 ](javascript:void\(0\);) 举报
...
下载地址： [ http://www.postgresqlstudio.org/download/
...
![](http://img.blog.csdn.net/20140619101505031?watermark/2/text/aHR0cDovL2Jsb2
...
![](http://img.blog.csdn.net/20140619101630468?watermark/2/text/aHR0cDovL2Jsb2
cuY3Nkbi5uZXQvcGxlYXNlY2FsbG1ld2h5/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA=
=/dissolve/70/gravity/SouthEast)  
...
编辑postgresql.conf文件，查找“listen_addresses ”字符串，然后修改为如下：
  ...
  * 上一篇  [ [Linux]在Mac下配置Linux服务器并安装Nginx+PHP ](/pleasecallmewhy/article/details/32104157)
  * 下一篇  [ [Cocos2d-x]Mac下cocos2d-x连接pomelo服务器 ](/pleasecallmewhy/article/details/34128199)
...
主题推荐
     ...
     [ postgresql ](http://www.csdn.net/tag/postgresql) [ 可视化 ](http://www.csdn.net/tag/可视化) [ sql ](http://www.csdn.net/tag/sql) [ 数据库 ](http://www.csdn.net/tag/数据库) [ 浏览器 ](http://www.csdn.net/tag/浏览器)
